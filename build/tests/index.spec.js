...
var ifImageExist_controller_1 = __importDefault(require("../controller/ifImageExist.controller"));
...
describe('Test if Image Exist or Not', function () {
    ...
    it('expect checkIfImagesExist function to return false with file name image_200_200.jpg ', function () {
...
describe('Test endpoint', function () {
    it('expect endpoint to return 200', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(img_routes_1.default).get('/images?fileName=fjord&width=100&height=200')];
                case 1:
                    response = _a.sent();
